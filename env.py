...
def to_setting():
    ...
    shutil.copyfile(os.path.join(abspath, "msedgedriver", ".condarc"), userhome)
    os.system("")
...
def clean():
    ...
    articledir = (
        r"C:\Users\10696\Desktop\crawler_spider\zhihu_spider_selenium\article"
    )
